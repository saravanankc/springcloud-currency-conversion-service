...
public interface CurrencyExchangeServiceProxy {
    ...
    @GetMapping("/currency-exchange-service/currency-exchange/from/{from}/to/{to}") //This is to support ZuuL API gateway. URL format is "hostname:port/application-name/uri"
